...
/**
 * Adapter to handle Sub-Rip Text (.srt) subtitle files.
 * It uses the Okapi's {@link net.sf.okapi.filters.regex.RegexFilter} class
 * with a regex specific to the srt format.
 *
 * @author Damian Jansen
 * <a href="mailto:djansen@redhat.com">djansen@redhat.com</a>
 */
public class SRTAdapter extends OkapiFilterAdapter {

    private static final String defaultConfig = loadDefaultConfig();

    private static String loadDefaultConfig() {
        URL configURL = SRTAdapter.class
                .getResource("SRTAdapterDefaultConfiguration.yml");
        try {
